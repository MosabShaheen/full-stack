...
export default function Features(){
    return (
        <section className="container max-w-full px-10 dark:bg-black dark:text-white py-10">
            <div className="">
            ...
            <p className="max-w-2xl mb-6">
                {"Inspired by "}
                <Link target="blank" href={"https://giga-stack.vercel.app/"} className="font-bold text-rose-400 underline">
                    Giga stack
                </Link>
                {" and "}
                <Link target="blank" href={"https://create.t3.gg/"} className="font-bold text-rose-400 underline">
                    T3 stack
                </Link>
            ...
            <div className="grid md:grid-cols-3 gap-5">
                ...
                <Link href={"https://github.com/drizzle-team/drizzle-orm/blob/main/drizzle-orm/src/mysql-core/README.md"} target="blank" className="box">
                    <strong className="text-2xl">Drizzle ORM</strong>
                    <p>{`If you know SQL, you know Drizzle ORM", TypeScript, db push with drizzle-kit`}</p>
                </Link>
                <Link href={"https://planetscale.com/"} target="blank" className="box">
